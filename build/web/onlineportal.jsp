		...
		<div class="panel-body center-block resize-body">
					...
					<label for="message"><font color="#e67e22" size="4"><%=message%></font></label>
						<div class="">
							...
							<label for="name"><font color="#0" size="4">Student Name</font></label> 
							<br>
							<input type="text" class="form-control" name=sname>
							
							<label for="aname"><font color="#0" size="4">Advisor Name</font></label> 
							<br>
							<input type="text" class="form-control" name=aname>
							
							<label for="que"><font color="#0" size="4">What is your question ?</font></label> 
							<br>
							<input type="text" class="form-control" name=que placeholder=""> 
						    <br>
						</div>
					</div>
